              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="bg-gradient-to-r from-emerald-300 to-sky-400 inline-flex gap-2 font-bold uppercase tracking-widest text-sm text-transparent bg-clip-text">
                    <span className="font-epilogue">{project.company}</span>
                    <span className="font-epilogue">&bull;</span>
                    <span className="font-epilogue">{project.year}</span>
                  </div>
                  <h3 className="font-outfit font-bold text-2xl mt-2 md:mt-5 md:text-4xl">
                    {project.title}
                  </h3>
                  ...
                  <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                    {project.results.map((result) => (
                      <li
                        key={result.title}
                        className="flex gap-2 font-manrope text-sm text-white/50 md:text-base"
                      >
                ...
                "
                    >
                      <span className="font-urbanist">More Details</span>
