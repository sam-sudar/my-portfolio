  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-10 overflow-x-clip">
      <div className="absolute inset-0 -z-10 [mask-image:linear-gradient(to_bottom,rgba(0,0,0,0),rgba(0,0,0,1)_10%,rgba(0,0,0,1)_70%,rgba(0,0,0,0))]">
        ...
        ></div>
        {/* Rings and Star animations  */}

        <div className="size-[630px] hero-ring"></div>
        <div className="size-[830px] hero-ring"></div>
        <div className="size-[1030px] hero-ring"></div>
        <div className="size-[1230px] hero-ring"></div>
        <HeroOrbit
          size={430}
          rotation={-14}
          shouldOrbit
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-righteous font-extrabold text-9xl md:text-7xl text-center mt-8 tracking-wide">
          ...
          <p className="mt-4 text-center font-fredoka text-white/60 md:text-lg">
            ...
            frontend frameworks like React, Next.js, and Vue, with a strong grip
            on backend technologies and clean architecture.
          </p>
        </div>
        <div className="flex flex-col md:flex-row items-center mt-8 justify-center gap-4">
          <button className="inline-flex cursor-pointer items-center gap-2 border border-white/15 px-6 h-12 rounded-xl">
            <span className="font-semibold font-urbanist">Explore My Work</span>
            <ArrowDown className="size-4" />
          </button>
          <button className="inline-flex cursor-pointer items-center gap-2 border bg-white text-gray-900 h-12 px-6 rounded-xl">
            <span>✋</span>
            <span className="font-semibold font-urbanist">Lets Connect</span>
          </button>
        </div>
      </div>
    </div>
